...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([])
    Error: An empty list cannot be tested.
    ...
    ...     {'type': 'dessert'},]
    ... )
    There is so far only one type of treat.

    >>> most_and_least_common_type(
    ...     [{'type': 'dessert'},
    ...     {'type': 'drink'}]
    ... )
    There is a tie between the treats.

    >>> most_and_least_common_type(9)
    Error: This is not an iterable object.

    >>> most_and_least_common_type(" ")
    Error: A string is not a list of treats!
